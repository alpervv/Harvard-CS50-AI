...
knowledge0 = And(Implication(AKnight, And(AKnight, AKnave)), Implication(AKnave, Not(And(AKnight, AKnave))), Or(AKnight, AKnave))
...
knowledge3 = And(
    Or(AKnave, AKnight), Or(BKnave, BKnight), Or(CKnave, CKnight),
